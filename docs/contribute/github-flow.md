<!-- Space: Projects -->
<!-- Parent: EnvSecrets -->
<!-- Title: Contributing GithubFlow EnvSecrets -->
<!-- Label: EnvSecrets -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to envsecrets project on [GitHub](https://github.com/luismayta/envsecrets), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/envsecrets/pulls).
...
To follow the instructions in this guide and start contributing to envsecrets project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/envsecrets.git
```

Now your **upstream** points to **luismayta/envsecrets**.
...
git fetch upstream # assuming upstream is luismayta/envsecrets
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/envsecrets/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
